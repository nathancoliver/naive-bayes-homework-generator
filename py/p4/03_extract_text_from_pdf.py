...
files = os.listdir('C:/Users/nathan.oliver/Desktop/Python/IG_Physics_Question_Bank/pdf/Questions_P4')
...
file_name = '0625_m15_qp_32.pdf'

page_text = []
doc_text = []

# path_pdf = 'C:/Users/nathan.oliver/Desktop/Python/IG_Physics_Question_Bank/pdf/Questions_P4/' + file
path_pdf = 'C:/Users/nathan.oliver/Desktop/Python/IG_Physics_Question_Bank/pdf/Questions_P4/' + '0625_m15_qp_32.pdf'
...
# page_text = page_text.replace(year,' ')
print(page_text)
